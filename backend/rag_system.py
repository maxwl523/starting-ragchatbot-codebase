...
from search_tools import ToolManager, CourseSearchTool, CourseOutlineTool, GetAllCoursesTool
...
class RAGSystem:
    ...
    def __init__(self, config):
        ...
        self.all_courses_tool = GetAllCoursesTool(self.vector_store)
        self.tool_manager.register_tool(self.all_courses_tool)
